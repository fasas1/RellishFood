...
namespace Rellish.Migrations
{
    ...
    [Migration("20230515112607_addOrderHeaderAndDetails")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rellish.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Rellish.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rellish.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rellish.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("Rellish.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("StripePaymentIntentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rellish.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Rellish.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Rellish.Models.CartItem", b =>
                {
                    b.HasOne("Rellish.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rellish.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Rellish.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("Rellish.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("Rellish.Models.OrderHeader", b =>
                {
                    b.HasOne("Rellish.Models.ApplicationUser", "User")
                        .WithMany()
